...
const AuctionPage = ({ currentUserId, onRequestLogin, onPay }) => {
            ...
            <div className="auction-list">
              {auctions.map((auction) => {
                ...
                const iWon =
                  ...
                  auction.currentHighestBidder.id === parseInt(currentUserId);
      ...
      {winningItem && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <p>
              You won the <strong>{winningItem.itemName}</strong>!
            </p>
