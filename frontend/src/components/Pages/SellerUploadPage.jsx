        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 space-y-4">
            <h3 className="font-bold text-blue-800 text-lg flex items-center gap-2">
              <Clock size={20} /> Auction Settings
            </h3>
              ...
              <div className="mt-4 p-4 bg-white rounded-lg border border-blue-200 animate-fade-in-up">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      name="decreaseIntervalSeconds"
                      value={form.decreaseIntervalSeconds}
                      onChange={handleChange}
                      className="w-full p-2 border rounded"
                    />
                  </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-xl text-lg font-bold shadow-lg transition-all transform hover:scale-[1.01] disabled:opacity-50 disabled:cursor-not-allowed"
          >
