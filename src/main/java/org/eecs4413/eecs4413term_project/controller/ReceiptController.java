...
public class ReceiptController {
    ...
    public ResponseEntity<String> createReceipt(@RequestParam String purchaseId,
                                                ...
                                                @RequestParam String winnerAddress,
                                                @RequestParam String ownerAddress,
                                                @RequestParam String ownerName,
                                                @RequestParam String auctionItem,
        ...
        // pass the Purchases entity instead of UUID
        try {
            User winner = new User(winnerName, true, winnerAddress);
            User owner = new User(ownerName, true, ownerAddress);
            Receipt receipt = new Receipt(purchase, winner, owner, auctionItem, amount, finalPrice, shippingDays);
